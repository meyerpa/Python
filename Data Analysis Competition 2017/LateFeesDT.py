# -*- coding: utf-8 -*-
"""
Created on Sun Apr  2 02:58:12 2017
...
from read import read_train, read_test, read_services
...
X_train, X_test, y_train, y_test = read_services(test_size=0.25)
...
X_train.to_csv(path_or_buf="x_train.csv", index=False)
...
# cross validate
n_folds = 4
cv_score = cross.score(clf, X_train, y_train, n_folds)
...
pred_data.to_csv(path_or_buf="prediction_latefees_decisiontree.csv", index=False)
